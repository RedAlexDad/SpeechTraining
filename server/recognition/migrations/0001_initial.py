# Generated by Django 4.1 on 2024-04-08 15:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_synthesis",
                    models.IntegerField(null=True, verbose_name="ID синтеза"),
                ),
                (
                    "id_recognition",
                    models.IntegerField(null=True, verbose_name="ID распознавания"),
                ),
                (
                    "id_client",
                    models.IntegerField(null=True, verbose_name="ID клиента"),
                ),
                (
                    "id_recommendation",
                    models.IntegerField(null=True, verbose_name="ID рекомендации"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text_for_check",
                    models.TextField(null=True, verbose_name="Текст для проверки"),
                ),
                (
                    "transcription_text",
                    models.TextField(null=True, verbose_name="Текст транскрибации"),
                ),
                (
                    "date_recoding",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_logodedist",
                    models.IntegerField(null=True, verbose_name="ID логопеда"),
                ),
                (
                    "recommendation_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text_synthesis",
                    models.TextField(null=True, verbose_name="Текст синтеза"),
                ),
                (
                    "text_input",
                    models.TextField(null=True, verbose_name="Введенный текст"),
                ),
                (
                    "date_synthesis",
